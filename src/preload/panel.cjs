...
contextBridge.exposeInMainWorld("xiaoluHome", {
  ...
  updateHistoryNote: (date, note) => ipcRenderer.invoke("xiaolu:update-history-note", date, note),
  ...
  setAutomaticGoals: (studyMinutes, questions) => ipcRenderer.invoke("xiaolu:set-automatic-goals", studyMinutes, questions),
